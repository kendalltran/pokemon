...
User1 = User(username="Ash Ketchum", useremail="ashketchum@gmail.com",
             picture="https://cdn.bulbagarden.net/upload/5/54/Ash_SM.png")
User2 = User(username="Brock", useremail="brock@gmail.com",
             picture="https://cdn.bulbagarden.net/upload/6/6a/Brock_SM.png")
User3 = User(username="Misty", useremail="misty@gmail.com",
...
Pokemon1 = Pokemon(pokemonname="Pikachu", user=User1,
                   picture="https://cdn.bulbagarden.net/upload/1/17/"
                   "025Pikachu-Original.png", gender="Male")
Pokemon2 = Pokemon(pokemonname="Onyx", user=User2,
                   picture="https://cdn.bulbagarden.net/upload/9/9a/"
                   "095Onix.png", gender="Female")
Pokemon3 = Pokemon(pokemonname="Staryu", user=User3,
                   picture="https://cdn.bulbagarden.net/upload/4/4f/"
                   "120Staryu.png", gender="Female")
Pokemon4 = Pokemon(pokemonname="Charizard", user=User1,
                   picture="https://cdn.bulbagarden.net/upload/7/7e/"
                   "006Charizard.png", gender="Male")
